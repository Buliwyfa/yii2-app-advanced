...
class Gallery extends ActiveRecord
{
    ...
    public function scenarios()
    {
        ...
        $scenarios['create'] = ['title', 'tag', 'language_id', 'status', 'items', 'created_at'];
        $scenarios['update'] = ['title', 'tag', 'language_id', 'status', 'items', 'updated_at'];
        return $scenarios;
    }
    ...
    {
        GalleryItem::deleteAll(['gallery_id' => $this->id]);
