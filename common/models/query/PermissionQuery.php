...
class PermissionQuery extends ActiveQuery
{
    ...
    {
        return $this->andWhere('[[status]]', ['status' => Permission::STATUS_ACTIVE]);
    }
    ...
    /**
     * @inheritdoc
     * @return \common\models\domain\Permission[]|array
     */
    ...
    /**
     * @inheritdoc
     * @return \common\models\domain\Permission|array|null
     */
